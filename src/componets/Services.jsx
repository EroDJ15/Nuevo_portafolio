...
const Services = () => {
  ...
  <div id="services" data-aos="fade-right" className="p-20 lg:p-20 items-center justify-center flex-col gap-2">
    <h1 data-aos="fade-down" className="text-[38px] font-semibold -mb-4 lg:mb-5 leading-normal text-white text-center">Services <br />
    <span className="text-fuchsia-500">And Skills</span></h1>
